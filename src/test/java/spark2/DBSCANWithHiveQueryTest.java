...
public class DBSCANWithHiveQueryTest {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Usage: %s inpath outPath fileProtocolPrefix", DBSCANWithHiveQueryTest.class.getSimpleName());
		System.out.println();
		System.out.printf("Usage: %s %s %s %s", DBSCANWithHiveQueryTest.class.getSimpleName(), inPath, outPath, fileProtocolPrefix);
		System.out.println();
